...
public class StreamEx14 {
    public static void main(String[] args) {
        ...
        // 1. 기본 분할
        Map<Boolean, List<MyStudent>> stuByGender = stream.collect(Collectors.partitioningBy(MyStudent::isGender));
        stuByGender.forEach((aBoolean, myStudents) -> {
        ...
        List<MyStudent> maleMyStudent = stuByGender.get(true);
        maleMyStudent.forEach(System.out::println);
    }
}
