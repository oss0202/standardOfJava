...
public class StreamEx15 {
    public static void main(String[] args) {
        ...
        // 2. 기본 분할 + 통계 정보
        Map<Boolean, Long> stuNumByGender = stream.collect(Collectors.partitioningBy(MyStudent::isGender, Collectors.counting()));
        stuNumByGender.forEach((aBoolean, aLong) -> {
            System.out.println((aBoolean?"남학생":"여학생") + " 수 : " + aLong);
        });
    }
}
